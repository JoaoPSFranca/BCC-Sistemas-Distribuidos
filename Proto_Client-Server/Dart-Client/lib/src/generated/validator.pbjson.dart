...
const ValidationRequest$json = {
  '1': 'ValidationRequest',
  '2': [
    {'1': 'document_number', '3': 1, '4': 1, '5': 9, '10': 'documentNumber'},
  ],
};
...
final $typed_data.Uint8List validationRequestDescriptor = $convert.base64Decode(
    'ChFWYWxpZGF0aW9uUmVxdWVzdBInCg9kb2N1bWVudF9udW1iZXIYASABKAlSDmRvY3VtZW50Tn'
    'VtYmVy');
...
final $typed_data.Uint8List validationResponseDescriptor =
    $convert.base64Decode(
        'ChJWYWxpZGF0aW9uUmVzcG9uc2USGQoIaXNfdmFsaWQYASABKAhSB2lzVmFsaWQ=');
